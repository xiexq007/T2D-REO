...
# getting stable REOs in T2D and ND samples respectively
...
def t2d_matrix(x):
    ...
    # set the threshold for obtaining REOs to 60%
    diff_po_re = (diff_po_num > (0.60 * sample_num)) * 1
    diff_ne_re = (diff_ne_num > (0.60 * sample_num)) * -1
